...
function Asidebar() {
  return (
    <>
      <div className="flex">
        <aside className="flex flex-col w-48 flex-shrink-0 px-5 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
          <div className="text-center text-2xl">BloggerSticks</div>
