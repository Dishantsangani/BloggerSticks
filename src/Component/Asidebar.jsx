  ...
  return (
    <>
      <div>
        ...
        <aside
          className={`fixed top-0 left-0 h-full w-48 z-40 px-5 py-4 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700 transition-transform duration-700 ease-in-out ${
