  ...
  return (
    <>
      <div className="overflow-x-hidden">
        <div className="relative py-10 sm:py-16 lg:pt-12 xl:pb-0">
            ...
            <div className="mx-auto max-w-3xl text-center">
              ...
              >
                ...
                <span className="relative inline-flex justify-center whitespace-nowrap font-bold">
                  <svg
                    className="absolute -bottom-8 hidden w-2/3 text-blue-500 sm:block"
                    viewBox="0 0 490 42"
                    fill="none"
              ...
              <p className="mx-auto mt-12 max-w-md leading-7 text-gray-600">
                BloggerStricks is a comprehensive online resource for bloggers
                of all levels.
              </p>
          ...
          >
            <div className="flex max-w-xs space-x-2 px-4 py-4">
              ...
              <p className="text-gray-600">
                Stay up-to-date with expert analysis and insights.
              </p>
            </div>
            <div className="flex max-w-xs space-x-2 px-4 py-4">
              <svg
              ...
              <p className="text-gray-600">
                Your go-to app for personalized news and financial updates.
              </p>
            </div>
            <div className="flex max-w-xs space-x-2 px-4 py-4">
              <svg
              ...
              <p className="text-gray-600">
                Your daily dose of news and financial analysis, all in one place
              </p>
            </div>
          </motion.div>
        </div>
        ...
        <div className="lg:flex items-center">
          ...
          >
            <h1 className="text-2xl font-semibold text-gray-800 dark:text-white lg:text-4xl">
              ...
              <br /> latest
              <span className="text-blue-500"> Blogging Trends</span>
            </h1>
            <p className="mt-3 text-gray-600 dark:text-gray-400">
              Join our vibrant community of bloggers and connect with
              like-minded individuals. Share your experiences, ask questions,
              and get inspired by the work of others.
            </p>
          </motion.div>
          {/* Image Section */}
          <motion.div
          ...
          >
            <img
              className="w-full h-full lg:max-w-md max-w-full max-h-full"
        ...
        <div className="flex flex-col lg:flex-row">
          <div className="lg:w-1/2">
            <p className="text-base text-gray-700">
              Bloggerstricks offers concise and insightful coverage of the
              latest news and finance trends. Our platform delivers up-to-date
              information and expert analysis to keep you informed and ahead of
              the curve.Whether you're seeking breaking news or strategic
              financial tips, Bloggerstricks has you covered.
            </p>
          </div>
          <div className="mb-2 lg:mb-0 lg:w-1/2 lg:pl-12">
            <h2 className="mb-5 font-sans text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl sm:leading-none">
              <span className="text-blue-500">Bloggerstricks</span>
              <br className="hidden md:block" />
              News & Finance Simplified
            </h2>
          </div>
        </div>
      </div>
          ...
          <div className="flex flex-col justify-center">
            <div className="max-w-xl mb-6">
              ...
              <p className="text-base text-gray-700 md:text-lg">
                Bloggerstricks is a dynamic platform that provides the latest
                news and valuable insights into the world of finance.
              </p>
            </div>
            <Link
              to="/trades"
