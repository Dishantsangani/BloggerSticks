          ...
          <div className="relative py-10 sm:py-16 lg:pt-12 xl:pb-0">
            ...
            >
              ...
              <div className="flex max-w-xs space-x-2 px-4 py-4">
                ...
                <p className="text-gray-600">
                  {" "}
                  Your daily dose of news and financial analysis, all in one
                  place
                </p>
              </div>
            </motion.div>
          ...
          <div className="flex flex-col lg:flex-row">
            <div className="lg:w-1/2">
              <p className="text-base text-gray-700">
                ...
                information and expert analysis to keep you informed and ahead
                of the curve.Whether you're seeking breaking news or strategic
