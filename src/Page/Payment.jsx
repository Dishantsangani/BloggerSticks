            ...
            <div className="mx-auto mt-8 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
              ...
              <div className="-mt-2 p-2 lg:mt-0 lg:w-full lg:max-w-md lg:flex-shrink-0">
                <SpotlightCard
                  ...
                  spotlightColor="rgba(27,37,84, 0.4)"
                >
                  <div className="mx-auto max-w-xs px-8">
                    ...
                    <button
                      ...
                      className="mt-10 block w-full rounded-md bg-blue-600 px-4 py-2 text-center text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                    >
                      Pay Now
                    </button>
